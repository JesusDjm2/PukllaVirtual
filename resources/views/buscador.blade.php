        ...
        <div class="centered-content">
            ...
            @else
                @php
                    ...
                    if ($librosCount > 0) {
                        $resultados[] = $librosCount . ' ' . ($librosCount === 1 ? 'Libro' : 'Libros');
                    }
                            ...
                            <div class="col-lg-4 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="drive d-flex justify-content-center align-items-center" style="height: 135px; background:url('{{asset('img/min/FONDO-DRIVE.webp')}}'); background-size: cover;">
