<nav id="sidebar">
    ...
    <div class="p-4 pt-5">
        <h1><a href="{{ route('home') }}" class="logo"><img src="{{ asset('img/Logo-Pukllasunchis-blanco.png') }}"
                    width="100%" alt=""></a></h1>
        <ul class="list-unstyled components mb-5">
            @role('admin')
                ...
                <li>
                    <a href="#take" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                            class="fa fa-building"></i> Take</a>
                    <ul class="collapse list-unstyled" id="take">
                        <li>
                            <a href="#">Page 1</a>
                        </li>
                        <li>
